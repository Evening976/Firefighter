...
public class FirefighterBoardTest {
    ...
    void testColumnCount(){
        Board<List<FFModelElement>> board = new FirefighterBoard(20, 10);
    ...
    void testGetState_afterUpdate(){
        Board<List<FFModelElement>> board = new FirefighterBoard(8, 8);
    ...
    void testFireFightervsFire(){
        FirefighterBoard board = new FirefighterBoard(8, 8);
                Position p1 = new Position(1,2);
